...
- **Northstar Home** — Executive business dashboard
- **ArcLane Distribution** — Operational command center
- **Clip-to-Everything** — Video-to-content pipeline

## Current Stack

HTML · CSS · JavaScript · Python · Google Sheets · GitHub · Netlify · Playwright
...
- [LinkedIn](https://www.linkedin.com/in/abdulhananvelynt/)
- [GitHub](https://github.com/hananbuilds)
